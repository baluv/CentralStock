...
<c:url var="saveRequestOrderURL" value="/stock/saveRequestOrder.html" />
<form:form modelAttribute="requestOrder" action="${saveRequestOrderURL}" name="requestOrder" id="requestOrder" onsubmit="return validateForm();" method="post"  >
<table width="500" align="left" cellpadding="20" cellspacing="10" >
    <tr>
       <th colspan="2" align="center" bgcolor="#D9D9D9">Enter the Request Details</th>
   </tr>
   <tr>
   ...
   <tr>
		...
		<td><input type="text"  class="datepicker" name="orderedDate" readonly="readonly"/>
	</tr>
	<tr>
		<td align="right">Order By:</td>
		<td><input type="text" name="orderedPerson" /></td>
	</tr>
	</table>
	<br>
