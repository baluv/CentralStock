...
<div id="sidebar"><b>
 ...
 <table width="500" align="left" cellpadding="20" cellspacing="10">
	 <tr>
		 <th colspan="2" align="center" bgcolor="#D9D9D9">The Current Stock Details</th>
	</tr>
	<%-- <tr>
		<td colspan="2" align="center" ><a href="viewDistributionIns.html"><strong> Present Stock Items Avalaible in ${insName}</strong></a></td>
	</tr> --%>
...
<br>
<br>
<table class="example2" align="center" cellpadding="10" cellspacing="10" width="400">     
        <tr>     
           <th width="60">S.NO</th>
           <th>Item Name</th>     
 		 ...
 		 <tr>  
 			<td align="center">${numberOfRows}</td>
            <td align="center">${map.key}</td>
            <td align="center">${map.value-map1.value}</td>   
         </tr>
 			</c:if>
            </c:forEach>  
            </c:forEach>     
