...
<table width="500" align="left" cellpadding="20" cellspacing="10">
	<tr>
		<th colspan="2" align="center" bgcolor="#D9D9D9">Confirm Purchase Stock Details</th>
	</tr>
</table>
<c:if test="${!empty orderList}">
	<table class="example2">
		...
		<c:forEach items="${orderList}" var="item">
			<tr>
				<td align="center" width="8%"><a href="/centralstockappnew/stock/viewPreConfirmStockItemsDetails.html?rid=${item.rid}&insName=${item.insName}&orderedDate=${item.orderedDate}&orderedPerson=${item.orderedPerson}"><c:out value="${item.rid}"></c:out></a></td>
